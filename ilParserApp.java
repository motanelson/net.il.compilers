...
public class ilParserApp {
    ...
    public static void main(String[] args) {
        ...
        // ==========================
        if (args.length == 0) {
            System.out.println("Uso: java ilParserApp <ficheiro.il>");
            return;
        }
        ...
        try {
            ...
            ilLexer lexer = new ilLexer(charStream);
            ...
            for (Token token : tokens.getTokens()) {
                String name = ilLexer.VOCABULARY.getSymbolicName(token.getType());
